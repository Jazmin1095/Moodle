...
.config(function($stateProvider, $urlRouterProvider, $translateProvider, $provide, $ionicConfigProvider) {
  ...
  $mmStateProvider
    ...
    .state('site.index', {
      ...
      views: {
        'site': {
          templateUrl: 'tpl/site-cursos.html',
    ...
    .state('site.grades', {
        ...
        .state('site.category', {
          ...
          views: {
            'site': {
              templateUrl: 'tpl/site-category.html'
            }
          }
        })
    .state('site.messages', {
    ...
    .state('site.files-system', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesSystemCtrl',
          templateUrl: 'tpl/site-files-system.html'
        }
      }
    })
    .state('site.files-asignaturas', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesAsignaturasCtrl',
          templateUrl: 'tpl/site-files-asignaturas.html'
        }
      }
    })
    .state('site.file-dalumnos', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesAlumnosCtrl',
          templateUrl: 'tpl/site-file-dalumnos.html'
        }
      }
    })
    .state('site.files-lenguas', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesLenguasCtrl',
          templateUrl: 'tpl/site-files-lenguas.html'
        }
      }
    })
    .state('site.files-tutorias', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesTutoriasCtrl',
          templateUrl: 'tpl/site-files-tutorias.html'
        }
      }
    })
    .state('site.file-antp', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesAntCtrl',
          templateUrl: 'tpl/site-file-antp.html'
        }
      }
    })
    
    
    .state('site.file-curso', {
      url: '/site?path',
      views: {
        'site': {
          controller: 'mmFilesCursoCtrl',
          templateUrl: 'tpl/site-file-curso.html'
        }
      }
    })
